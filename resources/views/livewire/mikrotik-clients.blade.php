                    ...
                    @forelse($clients as $client)
                        <tr>
                            ...
                            <td class="text-nowrap">
                                <a href="{{ route('reseller.customers.create', ['mikrotik_client' => $client->id]) }}" target="_blank" rel="noopener" class="btn btn-sm btn-info text-white" title="Export To Client List"><i class="bi bi-person-plus-fill"></i></a>

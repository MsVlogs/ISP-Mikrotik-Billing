    ...
    <div class="card shadow-sm border-0 mb-3">
        <div class="card-body">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-4 d-flex justify-content-end gap-2"><button wire:click="clearFilters" class="btn btn-danger"><i class="bi bi-x-circle me-1"></i>{{ __('Clear Filter') }}</button></div>
            </div>
        </div>
    </div>

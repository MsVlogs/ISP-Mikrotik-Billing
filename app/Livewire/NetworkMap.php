...
class NetworkMap extends Component
{
    ...
    public function render() {
        ...
        $nodes=CustomersAddress::query()->whereNotNull('latitude')->whereNotNull('longitude')->limit(1000)->get()->map(fn($a)=>['lat'=>(float)$a->latitude,'lng'=>(float)$a->longitude,'id'=>$a->customer_address_unique_id,'label'=>$a->label_name])->values();
